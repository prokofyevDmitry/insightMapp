...
// on choisi la $bdd dans laquelle ecrire, $la table , champ et valeur champ a mettre a jour, cible (champ ciblé et la valeur cible qui permettent de trouver les/la bonne ligne)
